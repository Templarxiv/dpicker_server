...
var AppComponent = (function () {
    function AppComponent(rest, shared) {
        var _this = this;
        this.rest = rest;
        this.shared = shared;
        this.title = 'app';
        this.page = "lobby";
        __WEBPACK_IMPORTED_MODULE_1__rest__["a" /* RestService */].Init();
        shared.page.subscribe(function (newValue) { return _this.page = newValue; });
    }
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__rest__ = __webpack_require__("../../../../../src/app/rest.ts");
...
var HeroesListComponent = (function () {
    function HeroesListComponent(appService, shared, rest) {
        var _this = this;
        ...
        //�-�-�-�-�-��-�-�-�-�-�-�-�-�-�-�-�-�-�
        this.order = ["b1", "b1", "b2", "b2", "p1", "p2", "p2", "p1", "b1", "b2", "b1", "b2", "p2", "p1", "p2", "p1", "b2", "b1", "p2", "p1"];
        this.currOrder = 0;
    ...
    HeroesListComponent.prototype.proceed = function (pId, id) {
        var _this = this;
        ...
        if (this.order[this.currOrder - 1] == "b1")
        ...
        if (this.order[this.currOrder - 1] == "b2")
        ...
        if (this.order[this.currOrder - 1] == "p1")
        ...
        if (this.order[this.currOrder - 1] == "p2")
        ...
        if (this.order[this.currOrder].includes("1"))
            this.curPlayer = 1;
        if (this.order[this.currOrder].includes("2"))
            this.curPlayer = 2;
    ...
    HeroesListComponent.prototype.heroClick = function (id) {
        if (this.curPlayer == 1 && __WEBPACK_IMPORTED_MODULE_4__rest__["a" /* RestService */].id != 0) {
            return;
        }
    ...
    HeroesListComponent.prototype.afterChoose = function (response) {
        ...
        if (response.currOrder.includes("b"))
            this.splashText = "BAN";
        if (response.currOrder.includes("p"))
            this.splashText = "PICK";
        this.time = 30;
        clearInterval(this.turnTime);
        this.turnTime = setInterval(function () { return _this.tick(); }, 1000);
        if (response.currOrder == "finish") {
            this.finish();
            return;
        }
    };
    HeroesListComponent.prototype.tick = function () {
        if (this.time > 0)
            this.time -= 1;
        else if (this.users[0].isPickTime)
            this.bonusTimeP1 -= 1;
        else
            this.bonusTimeP2 -= 1;
    };
...
var RestService = RestService_1 = (function () {
    function RestService(shared) {
        ...
        RestService_1.shared = shared;
    }
    RestService.Init = function () {
        RestService_1.socket = __WEBPACK_IMPORTED_MODULE_3_socket_io_client__["connect"](RestService_1.host);
    };
    RestService.Subscibe = function (event, callback) {
        RestService_1.socket.on(event, function (msg) {
            console.log(msg);
            callback(msg);
        });
    };
    RestService.post = function (event, param) {
        RestService_1.socket.emit(event, param);
    };
    RestService.get = function (url) {
    };
    return RestService;
}());
...
RestService = RestService_1 = __decorate([
...
var SharedService = (function () {
    function SharedService() {
        var _this = this;
        this.page = new __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"](function (observer) { return _this.observerPage = observer; });
        this.users = new __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"](function (observer) { return _this.observerUsers = observer; });
        this.updatePage("lobby");
    }
    SharedService.prototype.updatePage = function (value) {
        if (this.observerPage) {
            this.observerPage.next(value);
            console.log(value);
        }
    };
    SharedService.prototype.updateUsers = function (value) {
        if (this.observerUsers) {
            this.observerUsers.next(value);
            console.log(value);
        }
    };
